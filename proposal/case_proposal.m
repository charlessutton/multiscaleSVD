...
switch example_id
    ...
    case 2
        data_options = struct('type','gaussian_pulse_sum','n',1000,'D',100,'k',2,'sigma_pulse',0.1,'seed',555);
    case 3
        data_options = struct('type','gaussian_pulse_sum','n',1000,'D',100,'k',3,'sigma_pulse',0.1,'seed',555);
    case 4
    ...
    case 10
        data_options = struct('type','triangle_sum','n',1000,'D',50,'k',2,'sigma_pulse',0.1,'seed',555);               
    case 11
