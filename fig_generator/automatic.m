...
for type_params = 1:3
    ...
    for k_params = 1:5
        ...
        for noise_params = 1:4
            ...
            filename = sprintf('%s_%d_radius' , data_options.type, data_options.k);
            dlmwrite(cat(2,foldername,filename,expname,'.mat'),radius);
            
            filename = sprintf('%s_%d_Eeigenval' , data_options.type, data_options.k);
            dlmwrite(cat(2,foldername,filename,expname,'.mat'),Eeigenval);
            
            filename = sprintf('%s_%d_EReigenval' , data_options.type, data_options.k);
            dlmwrite(cat(2,foldername,filename,expname,'.mat'),EReigenval);
