...
switch example_id
    ...
    case 1
        data_options = struct('type','gaussian_pulse_sum','n',1000,'D',300,'k',1,'sigma_noise',0,'sigma_pulse',0.1,'seed',555);
    case 2
        data_options = struct('type','gaussian_pulse_sum','n',1000,'D',300,'k',2,'sigma_noise',0,'sigma_pulse',0.1,'seed',555);
    case 3
        data_options = struct('type','gaussian_pulse_sum','n',1000,'D',300,'k',3,'sigma_noise',0,'sigma_pulse',0.1,'seed',555);
    case 4
        data_options = struct('type','gaussian_pulse_sum','n',1000,'D',300,'k',4,'sigma_noise',0,'sigma_pulse',0.1,'seed',555);
    case 5
        data_options = struct('type','stair_sum','n',1000,'D',300,'k',1,'sigma_noise',0,'sigma_pulse',0.2,'seed',555);
    case 6
        data_options = struct('type','stair_sum','n',1000,'D',300,'k',2,'sigma_noise',0,'sigma_pulse',0.2,'seed',555);
    case 7
        data_options = struct('type','stair_sum','n',1000,'D',300,'k',3,'sigma_noise',0,'sigma_pulse',0.2,'seed',555);
    case 8
        data_options = struct('type','stair_sum','n',1000,'D',300,'k',4,'sigma_noise',0,'sigma_pulse',0.2,'seed',555);        
end
...
avg_nb_min = 10; % minimum neighbors accepted
avg_nb_max = max(avg_vector);
steps = linspace(avg_nb_min ,avg_nb_max, algo_options.it);
